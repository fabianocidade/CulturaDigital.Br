	...
	function widget($args, $instance)
	{
		...
		?>
        	<div id="hl-<?php echo $query->post->ID ?>">
				<?php if( the_thumb("medium", "") != '' ) echo '<a class="thumb" href="'. get_permalink() .'">'. the_thumb("medium", "") .'</a>'; else echo '<a class="thumb" href="'. get_permalink() .'"><img src="'. get_bloginfo('stylesheet_directory').'/global/img/graph/graph_destaque.jpg" alt="" /></a>'; ?>

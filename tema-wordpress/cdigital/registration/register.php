                ...
                <div class="marginRight20">
		            ...
		            <div class="page" id="register-page">
			            ...
			            <?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
                            ...
                            <p class="desc">* campos obrigatórios.</p>
				            ...
				            <div class="register-section" id="basic-details-section">
					            ...
					            <div class="inputDefault"><input type="password" name="signup_password" id="signup_password" value="<?php echo $_POST['signup_password']; ?>" /></div>

					            <label for="signup_password_confirm"><?php _e( 'Confirm Password', 'buddypress' ) ?>: *</label>
					            <?php do_action( 'bp_signup_password_confirm_errors' ) ?>
					            <div class="inputDefault"><input type="password" name="signup_password_confirm" id="signup_password_confirm" value="" /></div>
					            ...
					            <?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
						            ...
						            <div class="editfield">
							            ...
							            <?php if ( 'textbox' == bp_get_the_profile_field_type() ) : ?>
								            ...
								            <div class="inputDefault"><input type="text" name="<?php bp_the_profile_field_input_name() ?>" id="<?php bp_the_profile_field_input_name() ?>" value="<?php if(empty($_POST[bp_get_the_profile_field_input_name()])) bp_the_profile_field_edit_value(); else echo $_POST[bp_get_the_profile_field_input_name()]; ?>" /></div>
							            ...
							            <?php if ( 'textarea' == bp_get_the_profile_field_type() ) : ?>
								            ...
								            <label for="<?php bp_the_profile_field_input_name() ?>"><?php bp_the_profile_field_name() ?>: <?php if ( bp_get_the_profile_field_is_required() ) : ?>*<?php endif; ?></label>
								            <?php do_action( 'bp_' . bp_get_the_profile_field_input_name() . '_errors' ) ?>
								            <div class="inputDefault"><textarea rows="5" cols="40" name="<?php bp_the_profile_field_input_name() ?>" id="<?php bp_the_profile_field_input_name() ?>"><?php bp_the_profile_field_edit_value() ?></textarea></div>
							            ...
							            <?php if ( 'datebox' == bp_get_the_profile_field_type() ) : ?>
								            ...
								            <div class="datebox">
									            <label for="<?php bp_the_profile_field_input_name() ?>_day"><?php bp_the_profile_field_name() ?>: <?php if ( bp_get_the_profile_field_is_required() ) : ?>*<?php endif; ?></label>
									            <?php do_action( 'bp_' . bp_get_the_profile_field_input_name() . '_errors' ) ?>
				            ...
				            <?php if ( bp_get_blog_signup_allowed() ) : ?>
					            ...
					            <div class="register-section" id="blog-details-section">
						            ...
						            <div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
							            ...
							            <?php if ( 'yes' == VHOST ) : ?>
								            http:// <div class="inputDefault"><input type="text" name="signup_blog_url" id="signup_blog_url" value="<?php bp_signup_blog_url_value() ?>" /> .<?php echo str_replace( 'http://', '', site_url() ) ?></div>
							            <?php else : ?>
								            <?php echo site_url() ?>/ <div class="inputDefault"><input type="text" name="signup_blog_url" id="signup_blog_url" value="<?php bp_signup_blog_url_value() ?>" /></div>
							            <?php endif; ?>

							            <label for="signup_blog_title"><?php _e( 'Blog Title', 'buddypress' ) ?>: *</label>
							            <?php do_action( 'bp_signup_blog_title_errors' ) ?>
							            <div class="inputDefault"><input type="text" name="signup_blog_title" id="signup_blog_title" value="<?php bp_signup_blog_title_value() ?>" /></div>
				            ...
				            <div class="submit">
					            <input type="submit"name="signup_submit" class="submitDefault" id="signup_submit" value="<?php _e( 'Complete Sign Up', 'buddypress' ) ?> &rarr;" />
				            </div>
				            ...
				            <?php if ( bp_is_active( 'xprofile' ) && !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
					            ...
					            <?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
						            ...
						            <p>
							            ...
							            <input type="submit" class="submitDefault" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ) ?>" />
					            ...
					            <?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
						            ...
						            <input type="submit" class="submitDefault" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ) ?>" />

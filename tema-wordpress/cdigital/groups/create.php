                    ...
                    <form action="<?php bp_group_creation_form_action() ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
                        ...
                        <div class="item-body" id="group-create-body">
                            ...
                            <?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
                                ...
                                <input class="inputDefault" type="text" name="group-name" id="group-name" value="<?php bp_new_group_name() ?>" />
            
                                <label for="group-desc"><?php _e('* Group Description', 'buddypress') ?> <?php _e( '(required)', 'buddypress' )?></label>
                                <div class="inputDefault"><textarea name="group-desc" id="group-desc"><?php bp_new_group_description() ?></textarea></div>
                            ...
                            <?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
                                ...
                                <?php if ( !bp_get_avatar_admin_step() ) : ?>
                                    ...
                                    <div class="main-column">
                                        <p><?php _e("Upload an image to use as an avatar for this group.", 'buddypress') ?></p>
            
                                        <p>
                                            <input type="file" name="file" id="file" />
                                            <input class="submitDefault" type="submit" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ) ?>" />
                                ...
                                <?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
                                    ...
                                    <input class="submitDefault" type="submit" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ) ?>" />
                            ...
                            <?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
                                <div class="submit clear" id="previous-next">
                                    ...
                                    <?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
                                        <input class="submitDefault" type="submit" value="<?php _e('Next Step', 'buddypress') ?> &rarr;" id="group-creation-next" name="save" />
                                    <?php endif;?>
            
                                    <?php /* Create Button */ ?>
                                    <?php if ( bp_is_first_group_creation_step() ) : ?>
                                        <input class="submitDefault" type="submit" value="<?php _e('Create Group and Continue', 'buddypress') ?> &rarr;" id="group-creation-create" name="save" />
                                    <?php endif; ?>
            
                                    <?php /* Finish Button */ ?>
                                    <?php if ( bp_is_last_group_creation_step() ) : ?>
                                        <input class="submitDefault" type="submit" value="<?php _e('Finish', 'buddypress') ?> &rarr;" id="group-creation-finish" name="save" />
                                    <?php endif; ?>
                                </div>
                            <?php endif;?>

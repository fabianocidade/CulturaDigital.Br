...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<input class="inputDefault" type="text" name="group-name" id="group-name" value="<?php bp_group_name() ?>" />

	<label for="group-desc">* <?php _e( 'Group Description', 'buddypress' ) ?></label>
	<div class="inputDefault"><textarea name="group-desc" id="group-desc"><?php bp_group_description_editable() ?></textarea></div>
	...
	<p><input class="submitDefault" type="submit" value="<?php _e( 'Save Changes', 'buddypress' ) ?> &rarr;" id="save" name="save" /></p>
    <div class="clear"></div>

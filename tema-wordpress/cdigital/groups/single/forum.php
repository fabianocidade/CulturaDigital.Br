	...
	<?php if ( ( is_user_logged_in() && 'public' == bp_get_group_status() ) || bp_group_is_member() ) : ?>
		...
		<form action="" method="post" id="forum-topic-form" class="standard-form">
			<div id="post-new-topic">
				...
				<input type="text" name="topic_title" id="topic_title" class="inputDefault" value="" />

				<label for="topic_text"><?php _e( 'Content:', 'buddypress' ) ?></label>
				<div class="inputDefault"><textarea cols="5" rows="5" name="topic_text" id="topic_text"></textarea></div>
				...
				<div>
                	...
                	<input type="text" name="topic_tags" id="topic_tags" class="inputDefault" value="" />

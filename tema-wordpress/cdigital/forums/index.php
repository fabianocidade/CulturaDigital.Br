                        ...
                        <?php if ( is_user_logged_in() ) : ?>
                            ...
                            <?php if ( bp_has_groups( 'user_id=' . bp_loggedin_user_id() . '&type=alphabetical&max=100&per_page=100' ) ) : ?>
                                ...
                                <form action="" method="post" id="forum-topic-form" class="standard-form">
                                    ...
                                    <input type="text" class="inputDefault" name="topic_title" id="topic_title" value="" />
        
                                    <label><?php _e( 'Content:', 'buddypress' ) ?></label>
                                    <div class="inputDefault"><textarea name="topic_text" id="topic_text"></textarea></div>
        
                                    <label><?php _e( 'Tags (comma separated):', 'buddypress' ) ?></label>
                                    <input class="inputDefault" type="text" name="topic_tags" id="topic_tags" value="" />
                                    ...
                                    <div class="submit">
                                        ...
                                        <input class="submitDefault" type="button" name="submit_topic_cancel" id="submit_topic_cancel" value="<?php _e( 'Cancel', 'buddypress' ) ?>" />
                                    </div>

...
<?php // opcao default     if ( bp_has_activities( bp_ajax_querystring( 'activity' ) ) ) : ?>

<?php if ( bp_has_activities( 'per_page=12') ) : ?>


	<?php /* Show pagination if JS is not enabled, since the "Load More" link will do nothing */ ?><noscript>

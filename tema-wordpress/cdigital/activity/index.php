    		...
    		<div class="main">
                ...
                <ul class="bp_options">
                    <li id="activity-filter-select" class="last">
                        <select>
                            ...
                            <?php endif; } do_action( 'bp_activity_filter_options' ) ?>
                        </select>
                    </li>
                </ul>
			    ...
			    <div class="item-list-tabs activity-type-tabs">
				    <ul>
					    ...
					    <li class="selected" id="activity-all"><a href="<?php echo bp_loggedin_user_domain() . BP_ACTIVITY_SLUG . '/' ?>" title="<?php _e( 'The public activity for everyone on this site.', 'buddypress' ) ?>"><?php printf( __( 'Todos os membros (%s)', 'buddypress' ), bp_get_total_site_member_count() ) ?></a></li>

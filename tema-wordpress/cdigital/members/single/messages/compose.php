<form action="<?php bp_messages_form_action('compose') ?>" method="post" id="send_message_form" class="standard-form">
	...
	<ul class="first acfb-holder">
		<li>
			...
			<input type="text" name="send-to-input" class="send-to-input inputDefault" id="send-to-input" />
		</li>
	</ul>
	...
	<input type="text" name="subject" class="inputDefault" id="subject" value="<?php bp_messages_subject_value() ?>" />

	<label for="content"><?php _e( 'Message', 'buddypress') ?></label>
	<div class="inputDefault"><textarea name="content" id="message_content" rows="15" cols="40"><?php bp_messages_content_value() ?></textarea></div>
	...
	<div class="submit">
		<input type="submit" class="submitDefault" value="<?php _e( "Send Message", 'buddypress' ) ?> &rarr;" name="send" id="send" />

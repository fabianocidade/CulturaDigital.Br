		...
		<form id="send-reply" action="<?php bp_messages_form_action() ?>" method="post" class="standard-form">
			...
			<div class="message-box">
				...
				<div class="message-content">
					...
					<div class="inputDefault"><textarea name="content" id="message_content" rows="15" cols="40"></textarea></div>

					<?php do_action( 'bp_after_message_reply_box' ) ?>

					<div class="submit">
						<input class="submitDefault" type="submit" name="send" value="<?php _e( 'Send Reply', 'buddypress' ) ?> &rarr;" id="send_reply_button"/>

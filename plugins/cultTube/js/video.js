...
var parentIframe = window.parent.document.getElementById('videoPlayer');
var videoOrigZIndex = parentIframe.style.zIndex;
var defaultResolution = parentIframe.getAttribute('rel');
defaultResolution = defaultResolution.split('x');
var videoParentOrigWidth = defaultResolution[0];
var videoParentOrigHeight = defaultResolution[1];
...
var VideoJS = Class.extend({
  ...
  fullscreenOn: function(){
    if (!this.nativeFullscreenOn()) {
      ...
      // Resize the iframe
      parentIframe.style.width = window.parent.window.innerWidth + "px";
      parentIframe.style.height = window.parent.window.innerHeight + "px";
  ...
  fullscreenOff: function(){
    ...
    // Resize the iframe
    parentIframe.style.width = videoParentOrigWidth + "px";
    parentIframe.style.height = videoParentOrigHeight + "px";
    parentIframe.style.position = "static";
    parentIframe.style.zIndex = videoOrigZIndex;
